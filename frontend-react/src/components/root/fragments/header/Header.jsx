  ...
  return (
    <div className={`md:sticky top-0 z-10 ${isSticky ? 'shadow-lg bg-white' : 'bg-sky-50'}`}>
      <div className="flex justify-center items-center w-full">
        <div className={`bg-[#B7E0FF] border rounded-md md:rounded-none w-full flex  md:flex-row justify-between items-center py-2 px-4`}>
          <div className="ml-2 md:ml-10 flex items-center">
            <a href="/" className="no-underline">
              ...
              />
              <h2 className="ml-1 md:ml-3 text-base md:text-lg font-semibold">
                SPSS
              </h2>
            </a>
          </div>
