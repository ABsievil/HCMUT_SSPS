            ...
            <table className="w-full md:w-4/5 bg-white mt-3 m-auto">
                ...
                <tbody>
                    {rows.map((row, index) => (
                        <tr
                            key={index}
                            className={`${index % 2 === 0 ? 'bg-white hover:bg-gray-200' : 'bg-purple-100 hover:bg-purple-200'}
...
export default StudentPrintLogTable;