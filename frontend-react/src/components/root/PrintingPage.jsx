...
import Layout from "./PrintPage/Layout";
  ...
  return (
    <Layout>
      <div className="flex flex-col mt-20 w-full max-md:mt-10 max-md:max-w-full">
        ...
        <button className="flex flex-col justify-center self-center px-16 py-6 mt-56 max-w-full text-sm font-semibold tracking-wide leading-6 text-center text-white uppercase bg-blue-700 rounded-3xl w-[210px] max-md:px-5 max-md:mt-10">
